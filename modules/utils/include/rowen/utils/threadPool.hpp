#ifndef ROWEN_SDK_UTILS_THREAD_POOL_HPP
#define ROWEN_SDK_UTILS_THREAD_POOL_HPP
...
{
 public:
  thread_pool(size_t min_thread, size_t max_thread);
  ~thread_pool();
...
#endif  // ROWEN_SDK_UTILS_THREAD_POOL_HPP
